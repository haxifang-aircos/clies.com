...
class ParseAuthor extends Command
{
    ...
    public function handle()
    {
        ...
        for ($i = $index; $i <= $cycles; $i++) {
            ...
            // 获取知乎指定话题下的关注者用户信息
            $zhihu = $this->getFollowers(($i * 10) + 15, $topic);
